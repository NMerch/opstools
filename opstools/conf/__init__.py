...
from opstools.conf import global_settings

ENVIRONMENT_SETTINGS_VARIABLE = 'OPSTOOLS_SETTINGS_MODULE'
...
class LazySettings(LazyObject):
    ...
    Django uses the settings module pointed to by OPSTOOLS_SETTINGS_MODULE.
    """
